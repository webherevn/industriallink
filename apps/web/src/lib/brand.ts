/** Thương hiệu công khai — khớp domain inlink.vn. Slogan giữ nguyên. */
export const BRAND_NAME = 'inlink';
export const BRAND_TAGLINE = 'Kết nối nhân tài – Dẫn lối công nghiệp';
export const BRAND_SITE_HOST = 'inlink.vn';
